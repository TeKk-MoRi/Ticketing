...
namespace Service.Base
{
    ...
    {
        protected readonly TicketingContext _dbContext;

        protected BaseService(TicketingContext context)
        {
            _dbContext = context;
        }
    ...
    public class BaseService<T> : BaseService<T, int>
        where T : class
    {
        protected BaseService(TicketingContext context) : base(context)
        {
        }
    }
}
